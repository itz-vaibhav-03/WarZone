...
class NPC(AnimatedSprite):
    ...
    def draw_ray_cast(self):
        pg.draw.circle(self.game.screen, 'red', (68 * self.x, 68 * self.y), 10)
        if self.ray_cast_player_npc():
            pg.draw.line(self.game.screen, 'orange', (68 * self.game.player.x, 68 * self.game.player.y),
                         (68 * self.x, 68 * self.y), 2)
